...
namespace Biblioteca.Controllers
{
    public class Autenticacao
    {
        ...
        public static bool VerificaLoginSenha(string login, string senha, Controller controller)
        {
            ...
            {
                verficaSeUsuarioAdminExiste(bc);
        ...
        public static void verficaSeUsuarioAdminExiste(BibliotecaContext bc)
        {
        ...
        public static void verficaSeUsuarioAdminExiste(Controller controller)
        {
